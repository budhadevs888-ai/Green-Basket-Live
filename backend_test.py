...
def main():
    ...
    test_sequence = [
        ...
        ("🆕 Seller Register Endpoint", tester.test_new_seller_register_endpoint),
        ("Seller Add Products", tester.test_seller_products),
        ("Admin Approve Seller", tester.test_admin_approve_seller),
        ("🆕 Admin Products Endpoint", tester.test_admin_products_endpoint),
        ("🆕 Product Approval Workflow", tester.test_product_approval_workflow),
        ...
        ("🆕 Delivery Register Endpoint", tester.test_new_delivery_register_endpoint),
